...
const ftnApi = new Fortnite("d2002c2d-cbeb-4d0f-ba53-5145e0bbfd77");
...
module.exports.run = async (bot, message, args) => {
  ...
  if (!username)
    ...
    return message.channel.send(
      "Username not provided. Use the right syntax: `fornite <epic-username> [platform pc/xbl/psn] {mode all/season}`.\nFor lifetime stats use `.fbr <epic-username> [platform pc/xbl/psn]`"
    ); //Sends error message
